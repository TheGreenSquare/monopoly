...
function corrections() {
	...
	document.getElementById("enlarge5token").innerHTML += '<img src="src/img/railway.png" height="60" width="65" alt="" style="position: relative; bottom: 20px;" />';
	document.getElementById("enlarge15token").innerHTML += '<img src="src/img/railway.png" height="60" width="65" alt="" style="position: relative; top: -20px;" />';
	document.getElementById("enlarge25token").innerHTML += '<img src="src/img/railway.png" height="60" width="65" alt="" style="position: relative; top: -20px;" />';
	document.getElementById("enlarge35token").innerHTML += '<img src="src/img/railway.png" height="60" width="65" alt="" style="position: relative; top: -20px;" />';
